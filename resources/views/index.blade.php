...
<head>    
    ...
    <link rel="preload" href="{{asset('assetB/css/264f203fe2e5a9ff.css')}}" as="style" />
    <link rel="stylesheet" href="{{asset('assetB/css/264f203fe2e5a9ff.css')}}" data-n-g="" />
    <link rel="preload" href="{{asset('assetB/css/3281c8f3b42795ed.css')}}" as="style" />
    <link rel="stylesheet" href="{{asset('assetB/css/3281c8f3b42795ed.css')}}" data-n-p="" />
    <noscript data-n-css=""></noscript>
    
    <script src="{{asset('assetB/js/polyfills-c67a75d1b6f99dc8.js')}}"></script>
    <script src="{{asset('assetB/js/webpack-7ee66019f7f6d30f.js')}}" defer=""></script>
    <!-- <script src="{{asset('assetB/js/framework-9b5d6ec4444c80fa.js')}}" defer=""></script> -->
    <script src="{{asset('assetB/js/main-bc91bb9ee6775776.js')}}" defer=""></script>
    <!-- <script src="{{asset('assetB/js/_app-c833ef3483a1c39b.js')}}" defer=""></script> -->
    <script src="{{asset('assetB/js/962-d4f231a9c802ed66.js')}}" defer=""></script>
    <script src="{{asset('assetB/js/847-f7d84af3cf036d73.js')}}" defer=""></script>
    <!-- <script src="{{asset('assetB/js/index-714acf8c42b987b6.js')}}" defer=""></script> -->
    <script src="{{asset('assetB/js/_buildManifest.js')}}" defer=""></script>
    <script src="{{asset('assetB/js/_ssgManifest.js')}}" defer=""></script>
        ...
        <section>
            <div class="styles_container__lcSzG styles_hero__WQcec styles_loaded__7u685">
                ...
                <div class="styles_actions__KxSDg">
                    <button type="button" class="styles_button__gAHKk styles_fillBlue__7AYTO">
                        <span
                            ...
                            class="styles_image__9dfzG styles_loaded__4M8Ff undefined" loading="lazy" /></button><button
                        type="button" class="styles_button__gAHKk styles_fillGrey__yz8kb">
                        <span
